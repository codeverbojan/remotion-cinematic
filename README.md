...
- **Geometry-aware cursor** — targets real elements by ID, arc-interpolated movement, click/drag/resize with smart shape switching
...
- **387 tests** — engine, primitives, editor, schema, and end-to-end wiring
